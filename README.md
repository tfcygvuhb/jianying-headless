...
**本机预览档案：11.4.0 Build 481。** 该精确官方签名构建已完成桥接重建、
离线可编辑草稿构建与结构验证。首页登记因当前 macOS 自动增加未审核的安全扩展属性而
继续拒绝；已有工程编辑、原生资源和原生 MP4 导出也保持禁用。
...
- 另有精确 `11.4.0 Build 481` 离线草稿预览档案，仅适用于源码记录的完整身份。
...
- `11.4.0 Build 481` 当前仅开放离线新建草稿；首页登记、已有工程编辑、原生资源和
  原生 MP4 导出均保持失败关闭。
