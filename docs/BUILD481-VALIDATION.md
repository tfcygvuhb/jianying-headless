...
状态：基础素材和恒定变速 `enabled`，`native_export=true`；其他高级资源与运动能力保留独立门禁。
...
恒速只开放六个通过的精确倍率，2× 缺末帧反例及剩余倍率门禁见[恒速补验](BUILD481-SPEED-20260925.md)。
